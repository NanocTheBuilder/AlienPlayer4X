...
public class GroundBuyer extends TechBuyer {

    public GroundBuyer(Game game){
        super(game, Technology.GROUND_COMBAT);
    }

    @Override
    protected boolean isNeeded(Fleet fleet, FleetBuildOption... options) {
        return FleetBuildOption.isOption(COMBAT_IS_ABOVE_PLANET, options);
    }
}
