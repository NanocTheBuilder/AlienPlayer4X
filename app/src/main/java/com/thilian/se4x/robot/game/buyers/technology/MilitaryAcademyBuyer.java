...
public class MilitaryAcademyBuyer extends TechBuyer {
    public MilitaryAcademyBuyer(Game game){
        super(game, Technology.MILITARY_ACADEMY);
    }

    @Override
    protected boolean isNeeded(Fleet fleet, FleetBuildOption... options) {
        return game.isSeenThing(Seeable.VETERANS)
                && game.roller.roll() <= 6;
    }
}
