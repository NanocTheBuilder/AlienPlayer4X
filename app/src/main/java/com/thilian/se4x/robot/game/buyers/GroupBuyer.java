...
public abstract class GroupBuyer {
    protected void buyGroup(Fleet fleet, ShipType shipType) {
        buyGroup(fleet, shipType, 999);
    }

    protected void buyGroup(Fleet fleet, ShipType shipType, int maxToBuy) {
